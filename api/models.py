...
class Clientes(models.Model):
    ...
    futbol = models.ForeignKey(CanchasFutbol,db_column='futbol',on_delete=models.SET_NULL,null=True,blank=True)
    paddle = models.ForeignKey(CanchasPaddle,db_column='paddle',on_delete=models.SET_NULL,null=True,blank=True)
    gym = models.ForeignKey(Gym,db_column='gym',on_delete=models.SET_NULL,null=True,blank=True)
    pileta = models.ForeignKey(Pileta,db_column='pileta',on_delete=models.SET_NULL,null=True,blank=True)
    grupo = models.ForeignKey(GruposReserbas,db_column='grupo',on_delete=models.CASCADE,null=True)
    datos_usuario = models.ForeignKey("auth.user",on_delete=models.CASCADE,db_column="datos_usuario",related_name="datos_usuario")
    class Meta:
        db_table = "Clientes"
